...
create table dbo."CCContactAlert"(
    "contactAlertId" int GENERATED BY DEFAULT AS IDENTITY (START WITH 100 INCREMENT BY 1) primary key,
    "contactNo"      int not null,
    "alertCode"      varchar(40) not null,
    "modDate"        timestamp not null,
    "modUser"        varchar(20) not null,
    "modType"        char default 'I' not null,
    "startDate"      timestamp,
    "endDate"        timestamp,
    "modProc"        int
);
...
create table dbo."ccAddressAlert"(
    "addressAlertId" int GENERATED BY DEFAULT AS IDENTITY (START WITH 100 INCREMENT BY 1) primary key,
...
create table dbo."CCAddress"(
    "UPRN"              int GENERATED BY DEFAULT AS IDENTITY (START WITH 100 INCREMENT BY 1),
    "PropertyReference" varchar(25),
    "Addr1"             varchar(100),
    "Addr2"             varchar(100),
    "Addr3"             varchar(100),
    "Addr4"             varchar(100),
    ...
    "CountyID"          varchar(40),
    "AddressStatus"     varchar(40),
    "RealUPRN"          varchar(12),
    "modDate"           timestamp not null,
    "modUser"           varchar(20) not null,
    "modType"           char not null,
    "ProcessNo"         int,
    "AliasAddressCount" int,
    "u_ten_ref"         varchar(10),

...
The renaming of `CautionaryAlertsListener` into `SomethingElseListener` can be done by running a Renamer powershell script. To do so:
...
- Test coverage should never go down. (See the [test project readme](CautionaryAlertsListener.Tests/readme.md#Run-coverage) for how to run a coverage check.)

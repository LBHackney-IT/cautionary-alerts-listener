...
namespace CautionaryAlertsListener.Tests.Factories
{
    public class UseCaseFactoryTests
    {
        ...
        [Fact]
        public void PersonAddedToTenureEventUseCaseTest()
        {
            _event = ConstructEvent(EventTypes.PersonAddedToTenureEvent);
        ...
        [Fact]
        public void PersonRemovedFromTenureEventUseCase()
        {
        ...
        [Fact]
        public void PersonUpdatedEventUseCase()
        {
            _event = ConstructEvent(EventTypes.PersonUpdatedEvent);
            TestMessageProcessingCreation<IPersonUpdatedUseCase>(_event);
        }
    }
}
